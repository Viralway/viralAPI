...
class User:
    ...
    async def playlists(self, count=20, cursor=0, **kwargs) -> AsyncIterator[Playlist]:
        ...
        Returns:
            async iterator/generator: Yields ViralApi.playlist objects.
    ...
    async def videos(self, count=30, cursor=0, **kwargs) -> AsyncIterator[Video]:
        ...
        Returns:
            async iterator/generator: Yields ViralApi.video objects.
        ...
        Example Usage:
            .. code-block:: python
                ...
                async for video in api.user(username="tiktok").videos():
                    # do something
        """
        sec_uid = getattr(self, "sec_uid", None)
        if sec_uid is None or sec_uid == "":
    ...
    async def liked(
        ...
        Example Usage:
            .. code-block:: python
                ...
                async for like in api.user(username="tiktok").liked():
                    # do something
        """
        sec_uid = getattr(self, "sec_uid", None)
        if sec_uid is None or sec_uid == "":
    ...
    def __str__(self):
        ...
        sec_uid = getattr(self, "sec_uid", None)
        return f"ViralApi.user(username='{username}', user_id='{user_id}', sec_uid='{sec_uid}')"
