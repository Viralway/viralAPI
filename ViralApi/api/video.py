...
class Video:
    ...
    async def info(self, **kwargs) -> dict:
        ...
        Example Usage:
            .. code-block:: python
                ...
                url = "https://www.tiktok.com/@tiktok/video/7106686413101468970"
    ...
    async def comments(self, count=20, cursor=0, **kwargs) -> AsyncIterator[Comment]:
        ...
        Returns:
            async iterator/generator: Yields ViralApi.comment objects.
    ...
    def __str__(self):
        return f"ViralApi.video(id='{getattr(self, 'id', None)}')"
