...
class ViralApi:
    """The main ViralApi class that contains all the endpoints.
    ...
    def __del__(self):
        ...
        if not self._cleanup_called:
            if self.sessions or self.browser or self.playwright:
                self.logger.warning(
                    "ViralApi object is being destroyed but cleanup was not called. "
                    "Please use 'async with ViralApi()' or call 'await api.close_sessions()' and "
    ...
    async def create_sessions(
        ...
        """
        Create sessions for use within the ViralApi class.
        ...
        Args:
            ...
            proxy_provider (ProxyProvider | None): A ProxyProvider instance for smart proxy rotation.
                                                   See examples/proxy_provider_example.py for usage examples.
        ...
        Custom Launchers:
            ...
            These arguments are callable functions that Viral API will use to launch your browser and pages,
    ...
    async def close_sessions(self):
        """
        Close all the sessions. Should be called when you're done with the ViralApi object

        This is called automatically when using the ViralApi with "with"
        """
        ...
        **kwargs,
        ...
        while retry_count < retries:
            ...
            try:
                ...
                if result is None:
                    raise Exception("ViralApi.run_fetch_script returned None")
