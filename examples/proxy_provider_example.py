...
This example demonstrates how to use the ProxyProviders package with Viral API
for smart proxy rotation and management.

Requirements:
    pip install ViralApi proxyproviders
...
async def main():
    ...
    if not os.environ.get("WEBSHARE_API_KEY"):
        ...
        print("Set WEBSHARE_API_KEY to run the Webshare examples.")
